"""
run_profile_noz2p2.py
Profile likelihood scan over DDE template amplitude epsilon.
EXCLUDES z=2.2 bin (min_z=2.4), following Simeon's suggestion.
...
# ── Baseline likelihood ────────────────────────────────────────────────────
print("="*60)
print(f"Profile likelihood — {LABEL} (min_z={MIN_Z}, z=2.2 excluded)")
print("="*60)
...
ax.axvline(best_eps, color='steelblue', linestyle=':',
           linewidth=1.0,
...
ax.set_title(
    f'Profile likelihood — {LABEL} (z=2.2 excluded)\n'
